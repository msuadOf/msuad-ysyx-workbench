...
#define PARAM_DEBUG(tentry,parameter) ((int)((int)(*((uint8_t*)(((uint32_t)tentry)?(0x80000000):((uint32_t)tentry))))-(int)(*((uint8_t*)(((uint32_t)parameter)?(0x80000000):((uint32_t)parameter))))+0x5AA5))
