...
INSTPAT("??????? ????? ????? 010 ????? 00100 11", slti    , I, R(rd) = (sword_t)src1 < imm);
...
INSTPAT("0000001 ????? ????? 001 ????? 01100 11", mulh   , R, R(rd) = SEXT(src1, 32) / SEXT(src2, 32));
INSTPAT("0000001 ????? ????? 010 ????? 01100 11", mulhsu   , R, R(rd) = SEXT(src1, 32) / SEXT(src2, 32));
INSTPAT("0000001 ????? ????? 011 ????? 01100 11", mulhu   , R, R(rd) = SEXT(src1, 32) / SEXT(src2, 32));
INSTPAT("0000001 ????? ????? 100 ????? 01100 11", div   , R, R(rd) = SEXT(src1, 32) / SEXT(src2, 32));
INSTPAT("0000001 ????? ????? 101 ????? 01100 11", divu   , R, R(rd) = SEXT(src1, 32) / SEXT(src2, 32));
INSTPAT("0000001 ????? ????? 110 ????? 01100 11", rem   , R, R(rd) = SEXT(src1, 32) % SEXT(src2, 32));
INSTPAT("0000001 ????? ????? 111 ????? 01100 11", remu   , R, R(rd) = SEXT(src1, 32) % SEXT(src2, 32));
