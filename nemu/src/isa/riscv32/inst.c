...
// INSTPAT("0000001 ????? ????? 001 ????? 01100 11", mulh   , R, R(rd) = ( ( (int64_t)SEXT(src1, 64) ) * ( (int64_t)SEXT(src2, 64) ) )>>32 );
// INSTPAT("0000001 ????? ????? 010 ????? 01100 11", mulhsu   , R, R(rd) = ( ( (int64_t)SEXT(src1, 64) ) * ( (uint64_t)src2 ) )>>32 );
